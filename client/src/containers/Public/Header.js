...
const Header = () => {
  ...
  return (
    <div className='w-3/5 px-5 flex items-center justify-between'>
      <img src={logo}
        alt="logo"
      ...
      <div className='flex items-center gap-1'>
        ...
        <Button text={'Đăng kí'} textColor='text-white' bgColor='bg-[#33CC33]' IcAfter={GiArchiveRegister} onClick={goLogin} />
