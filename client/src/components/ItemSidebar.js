...
const ItemSidebar = () => {
  ...
  function categoryBar() {
    const currentPath = location.pathname.toString().replace('/', '')
    console.log('path: ', currentPath)
    console.log('path: ', path.CHO_THUE_CAN_HO)
    if (currentPath !== path.CHO_THUE_CAN_HO && currentPath !== path.CHO_THUE_MAT_BANG && currentPath !== path.NHA_CHO_THUE && currentPath !== path.CHO_THUE_PHONG_TRO) {
      return (
