export const text = {
    title: 'Tại sao bạn nên chọn chúng tôi ?',
    description: 'Chúng tôi biết bạn có rất nhiều lựa chọn, nhưng PhongTroBk tự hào là trang web đứng top google về các từ khóa: Phongtro, ChoThuePhongTro, ',
